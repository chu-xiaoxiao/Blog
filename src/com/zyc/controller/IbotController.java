...
public class IbotController {
	...
	public void getmsg(HttpServletRequest request,HttpServletResponse response,@CookieValue("JSESSIONID")String sessionid) throws ClientProtocolException, IOException, JSONException, ParseException{
		...
		org.codehaus.jettison.json.JSONObject jsonObject2 = new org.codehaus.jettison.json.JSONObject(result);

...
$(function(){
	...
	$('#upload_'+i).Huploadify({
		...
		removeTimeout: 1000,
		uploader:'/SSM/Houtai/modifyJuziImgAction.do?id='+i,
            ...
            <div class="panel panel-default">
             ...
             <form action="/SSM/Houtai/modifyJuziaction.do">
            	...
            	<c:forEach items="${requestScope.juzis }" var="juzi">
	                <div class="form-group">
	                     <label> <img src="/home/imgs/${juzi.key}" height="200px" width="200px" name="img${cf:substring(juzi.key,4,cf:length(juzi.key))}"></label><div id="upload_${count }"></div>
	                     <input class="form-control" value="${juzi.value}" name="juzi${cf:substring(juzi.key,4,cf:length(juzi.key))}"/>

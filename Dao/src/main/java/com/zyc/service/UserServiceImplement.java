...
public class UserServiceImplement implements UserService {
	...
	@Override
	public List<User> findUserWithPower(UserExample userExample) {
		return userMapper.selectUserWithPower(userExample);
	}

	@Override
	public User findUserWithPowerByPrimaryKey(Integer id) {
		return userMapper.selectUserWithPowerByPrimaryKey(id);
	}
}
